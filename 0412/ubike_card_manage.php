                                        ...
                                        <div class="row">
                                            ...
                                            <div style="padding-bottom: 5px;">
                                                ...
                                                <div class="icon-box" style="padding-left: 10%;">
                                                    ...
                                                    <h3><a href="#"><? echo $record[1] ?>&nbsp;&nbsp;<span style="font-size: 13px;">卡號:<? echo $record[0] ?></span></a></h3>
                                                    <p style="padding-bottom: 10px;">
                                                        ...
                                                        <!-- 刪除綁定卡片按鈕 -->
                                                        <? echo "<a href=ubike_card_delete.php?method=ubike_card_delete&ubike_card_id=$record[0]>" ?><button type="submit" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                                            刪除卡片
                                                        </button></a>
