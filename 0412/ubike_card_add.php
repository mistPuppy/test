                            ...
                            <section id="featured" class="featured">
                                <div class="container">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4">
                                            <center>
                                            <? echo "<a href=ubike_card_num.php?method=ubike_card_num&ubike_card_type=悠遊卡>" ?>
                                                <div class="icon-box">
                                        ...
                                        <div class="col-lg-4 mt-4 mt-lg-0">
                                            <center>
                                            <? echo "<a href=ubike_card_num.php?method=ubike_card_num&ubike_card_type=一卡通>" ?>                                              
                                                    <div class="icon-box">
                                        ...
                                        <div class="col-lg-4 mt-4 mt-lg-0">
                                            <center>
                                            <? echo "<a href=ubike_card_num.php?method=ubike_card_num&ubike_card_type=信用卡>" ?>
                                                <div class="icon-box">
