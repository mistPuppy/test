    ...
    <div style="display: flex; flex-direction: row">
        <div>
            <div style="text-align: center; border-radius: 10px; border-right: 4px solid #00BB00; width:100%; background-color: #dadadab6; height: 100%; margin-left: 20px; margin-right:12px; padding: 12px;"><br>
                <a href="評分紀錄.php" id='secondButton1' target="pic" style='margin-right: 8px; font-size: 17px; padding: 5px; border-radius: 3px; text-decoration: none; color: #00BB00'><b><i class="fas fa-folder-open" style="margin-right: 10px;"></i>評分紀錄總覽</b></a><br>
                <hr style='margin: 20px'>
                <div style='text-align: center'>
                    <?php
                    while ($record = mysqli_fetch_row($rs)) {
                        echo "<a href='評分紀錄2.php?title_num=$record[2]&title_name=$record[1]' id='secondButton1' target='pic' style='font-size: 17px; padding: 5px; border-radius: 3px; text-decoration: none'><b>", $record[1], "<br>", $record[2],
                        "</b></a>
                    <hr style='margin: 20px'>";
                    }
                    ?>
        ...
        <iframe src="評分紀錄.php" name="pic" style="height: 1150px; width: 95%; margin-left: 40px" frameborder="0"></iframe>
    </div>
