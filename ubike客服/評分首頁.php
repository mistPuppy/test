    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <center><br>
                ...
                <div style="color: red; font-size: 15px"><br>
                    &nbsp;<b>（<i class="fas fa-exclamation-triangle"></i>&nbsp;請注意，系統將會儲存此登入帳號之評分紀錄！）</b>
                </div>
                <br>
            </center>
        </div>
                            ...
                            <div class="pre" style="color: grey;">
                                ...
                                <table>
                                    <tr>
                                        ...
                                        <td><input name="titlecontent_grade" value="<?php echo $titlecontent_grade ?>" class="form-control" class="input" type="text" style="margin-right: 20px; color: grey; text-transform: uppercase; width: 250px; height: 30px;" placeholder=""></td>
                                        <td>評等：</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select name="titlecontent_note" class="form-control" style="width: 280px; margin-right: 20px">
