...
<body>
    ...
    <div style="display: flex; flex-direction: row">
        <div>
            <div style="border-radius: 10px; border-right: 4px solid #00BB00; width:100%; background-color: #dadadab6; height: 100%; margin-left: 20px; margin-right:12px; padding: 12px; text-align: center;"><br>
                ...
                while ($record = mysqli_fetch_row($rs)) {
                    echo "<a href='評分介面.php?title_num=$record[2]&title_name=$record[1]' id='secondButton1' target='pic' style='font-size: 17px; padding: 5px; border-radius: 3px; text-decoration: none'><b>", $record[1], "<br>", $record[2],
                    "</b></a>
        ...
        <iframe src="評分首頁.php" name="pic" style="height: 1600px; width: 95%; margin-left: 40px" frameborder="0"></iframe>
    </div>
