...
<body>
    ...
    <form action="dblink.php" method="post" class="form-horizontal" style=" background-color:white;
        ...
        <input type="hidden" name="method_sin" value="<?php echo $method_sin ?>">
        <div class="pre" style="font-weight: bold;">
            ...
            <table>
                <tbody>
                        ...
                        <td>
                            <select class="form-control" style="width: 280px;">
                                ...
                                // while ($record = mysqli_fetch_row($rs)) {
                                    // echo "<option value='$team_專題編號$team_專題名稱'>$record[1]$record[2]</option>";
                                // }
                                ?>
                            </select>
                        </td>
                    ...
                    <tr>
                        <td style="padding: 5px;"><input class="form-control" style="width: 447px; color: grey; text-transform: uppercase;" type="text" name="team_專題編號" value="<?php echo $team_專題編號 ?>" placeholder="專題編號：（輸入格式：【專題編號】）"></td>
                        <td style="padding: 5px;"><input class="form-control" style="width: 447px; color: grey; text-transform: uppercase;" type="text" name="team_專題名稱" value="<?php echo $team_專題名稱 ?>" placeholder="專題名稱："></td>
                    </tr>
                    <tr>
            ...
            <center>
                <table>
                    <tr>
                        <td style="width: 158px;"><a href="新增專題成員.php"><input class="form-control" type="reset" value="重新輸入" style="color: white; text-transform: uppercase; width: 150px; background-color: #858796"></a></td>
                        <td>
