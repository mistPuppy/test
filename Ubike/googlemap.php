        ...
        function initMap() {
            ...
            for (let i = 0; i < MapOptions.length; i++) {
                ...
                const contentString =
                    ...
                    '</td>' +
                    '<td style="width:20%; text-align:center; font-size:15px">距離**km</td>' +
                    ...
                    '<button type="button" style="margin-left: 4px; padding:6px; background-color:#00A600; border-radius:7px; border:none; color:aliceblue; box-shadow:5px;" data-bs-toggle="modal" data-bs-target="#exampleModal">顯示規劃路線</button>' +
                    '</td>' +
                    '</tr>' +
                    '<tr>' +
                    '<td style="text-align: center;"><button type="button" style="margin-left: 4px; padding: 6px;background-color:	#0080FF ;border-radius: 7px ;border: none; color: aliceblue;box-shadow: 5px;" data-bs-toggle="modal" data-bs-target="#exampleModal">建議還車站點</button></td>' +
                    '</tr>' +
                    '</table>' +
...
<body>
    <div id="map"></div>
    <script defer async src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAvNrHicWm9EGNy0d3JOn8amUWHwiMAk44&callback=initMap&v=weekly"></script>
</body>
