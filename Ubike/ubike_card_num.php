...
<body>
    <form method="post" action="ubike_card_dblink.php">
        ...
        <input type=hidden name="ubike_card_type" value="<?php echo $ubike_card_type ?>">
                            ...
                            <article class="entry">
                                <center>
                                    <h1 class="entry-title" style="margin-bottom:30px; font-size: 50px; ">
                                        <a href="#">新增<?php echo $ubike_card_type ?></a>
                                    </h1>
                                </center>
                                <!-- ======= 一卡通 ======= -->
                                <div class="container">
                                                    ...
                                                    <form action="forms/contact.php" method="post" role="form" class="php-email-form">
                                                        ...
                                                        <center>
                                                            <div class="input-group mb-3" style="width:80%;">
                                                                ...
                                                                <input type="text" class="form-control" value="<?php echo $ubike_user_account ?>" aria-label="Username" aria-describedby="basic-addon1" readonly>
                                                            </div>
                                                        </center>
                                                        <center>
                                                            <div class="input-group mb-3" style="width:80%;">
                                                                <span class="input-group-text">卡號:</span>
                                                                <input required name="ubike_card_id" type="text" class="form-control" value="<?php echo $ubike_card_id ?>" aria-label="Amount (to the nearest dollar)">
