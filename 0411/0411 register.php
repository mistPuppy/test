    ...
    <section id="contact" class="contact">
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-6 ">
            <center><a href="index.html" class="mb-4 mb-lg-0" style="border:0"><img src="https://www.youbike.com.tw/images/wel_mask.png" width="75%" height="75%"></a>
          </div>
          ...
          <div class="col-lg-6" style="margin-top:100px">
            <form method="post" style="backgroung-color:#fff; box-shadow:0px 0px 4px 4px #F0F0F0; padding:45px;">
              ...
              <div class="text-center mt-3"><button type="submit" style="background: #e96b56;  border: 0;  border-radius: 50px;  padding: 10px 24px;  transition: 0.4s; color:#fff; margin-top: 20px">註冊</button></div>              
            </form>
            <?php
